          ...
          {selectedEstimate && editedEstimate && (
            <div className="modal-overlay">
              <div className="modal-content">
                ...
                <div className="modal-footer"><button className="cancel-button" onClick={() => setSelectedEstimate(null)}>Cancelar</button><button className="save-button" onClick={handleSaveEstimate}>Salvar Alterações</button></div>
              </div>
            </div>
          )}
        </>
