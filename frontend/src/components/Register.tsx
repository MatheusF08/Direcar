...
interface RegisterProps { onSwitchToLogin: ( ) => void; }
  ...
  return (
    <div className="login-container">
      <form onSubmit={handleSubmit} className="login-form">
        ...
        <p className="switch-form-text">Já tem uma conta?{' '}<span onClick={onSwitchToLogin} className="switch-form-link">Faça o login</span></p>
      </form>
    </div>
  );
};
